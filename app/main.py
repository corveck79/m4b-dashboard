...
async def run_collection():
    ...
    import time
    _last_collect_time = time.strftime("%Y-%m-%d %H:%M %Z")
...
SETTINGS_KEYS = [
    ...
    "EARNFM_EMAIL", "EARNFM_PASSWORD", "EARNFM_API_KEY", "CONTAINER_EARNFM",
    "PROXYRACK_API_KEY", "PROXYRACK_UUID", "CONTAINER_PROXYRACK",
    "BITPING_EMAIL", "BITPING_PASSWORD", "CONTAINER_BITPING",
    "MYSTNODES_EMAIL", "MYSTNODES_PASSWORD", "MYST_NODES", "MYST_PASSWORD", "MYST_TEQUILAPI_HOST", "CONTAINER_MYSTERIUM",
    "COLLECT_INTERVAL_MINUTES",
]
MASKED_KEYS = {"HONEYGAIN_PASSWORD", "IPROYAL_PASSWORD", "PACKETSTREAM_PASSWORD", "TRAFFMONETIZER_PASSWORD", "REPOCKET_PASSWORD", "BITPING_PASSWORD", "MYST_PASSWORD", "MYSTNODES_PASSWORD", "EARNFM_PASSWORD"}
_MASK = "••••••••"
