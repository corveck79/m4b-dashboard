...
SETTINGS_KEYS = [
    ...
    "REPOCKET_EMAIL", "REPOCKET_API_KEY", "CONTAINER_REPOCKET",
...
MASKED_KEYS = {"HONEYGAIN_PASSWORD", "IPROYAL_PASSWORD", "PACKETSTREAM_PASSWORD", "TRAFFMONETIZER_PASSWORD", "BITPING_PASSWORD"}
_MASK = "••••••••"
