...
MASKED_KEYS = {"HONEYGAIN_PASSWORD", "IPROYAL_PASSWORD", "PACKETSTREAM_PASSWORD", "TRAFFMONETIZER_PASSWORD", "REPOCKET_PASSWORD", "BITPING_PASSWORD", "MYST_PASSWORD", "MYSTNODES_PASSWORD"}
_MASK = "••••••••"
